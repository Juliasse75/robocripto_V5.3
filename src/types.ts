...
export type ExitType = 'TAKE_PROFIT' | 'STOP_LOSS' | 'RESGATE_GRID' | 'SAQUE_SEXTA' | 'FECHAMENTO_MANUAL' | 'ENTRADA_PYTHON_V53' | 'TAKE_PROFIT_PYTHON_V53' | 'COMPRA_V53' | 'ENTRADA_AUTO_V53' | 'TAKE_PROFIT_AUTO_V53' | 'STOP_LOSS_AUTO_V53' | 'TRAILING_STOP_AUTO_V53';
